                ...
                <div id="carouselExample" className="carousel slide mt-5 mb-5" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item active text-center">
                            <img src="/airbnb.png" className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Airbnb Project" />
                        ...
                        <div className="carousel-item text-center">
                            <img src="/blogs.png" className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Blog App" />
                        ...
                        {/* Carousel Item 3 */}
                        <div className="carousel-item text-center">
                            <img src="/chats.png" className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Chat App" />
                        ...
                        {/* Carousel Item 4 */}
                        <div className="carousel-item text-center">
                            <img src="/spotify.png" className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Spotify Clone" />
                        ...
                        {/* Carousel Item 5 */}
                        <div className="carousel-item text-center">
                            <img src="/simon.png" className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Simon Game" />
                        ...
                        <div className="carousel-item text-center">
                            <img src="https://d14b9ctw0m6fid.cloudfront.net/ugblog/wp-content/uploads/2021/03/1986.png"
                                className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Heart Disease ML" />
                        ...
                        <div className="carousel-item text-center">
                            <img src="https://assets-global.website-files.com/5fbe376a36d4106214faaf3c/6127f11ea022d75c6f326715_6-OpenGraphImage-InsuranceCosts.png"
                                className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Insurance ML" />
                        ...
                        <div className="carousel-item text-center">
                            <img src="https://static.packt-cdn.com/products/9781800200456/graphics/image/B16182_01_08.jpg"
                                className="d-block mx-auto" style={{ width: "80%", maxHeight: "300px", objectFit: "contain" }} alt="Cat vs Dog CNN" />
